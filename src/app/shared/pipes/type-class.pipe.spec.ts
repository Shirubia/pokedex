...
describe('TypeClassPipe', () => {
  ...
  it('returns correct classes for normal type', () => {
    expect(pipe.transform('normal')).toBe(
  ...
  it('returns correct classes for fire type', () => {
    expect(pipe.transform('fire')).toBe(
      'bg-orange-50 text-orange-700 ring-orange-700/10 dark:bg-orange-900 dark:text-orange-300 dark:ring-orange-500/10',
    );
  });

  it('returns correct classes for water type', () => {
    expect(pipe.transform('water')).toBe(
  ...
  it('returns correct classes for electric type', () => {
    expect(pipe.transform('electric')).toBe(
  ...
  it('returns correct classes for grass type', () => {
    expect(pipe.transform('grass')).toBe(
  ...
  it('returns correct classes for ice type', () => {
    expect(pipe.transform('ice')).toBe(
      'bg-cyan-50 text-cyan-700 ring-cyan-700/10 dark:bg-cyan-900 dark:text-cyan-300 dark:ring-cyan-500/10',
    );
  });

  it('returns correct classes for fighting type', () => {
    expect(pipe.transform('fighting')).toBe(
  ...
  it('returns correct classes for poison type', () => {
    expect(pipe.transform('poison')).toBe(
  ...
  it('returns correct classes for ground type', () => {
    expect(pipe.transform('ground')).toBe(
  ...
  it('returns correct classes for flying type', () => {
    expect(pipe.transform('flying')).toBe(
  ...
  it('returns correct classes for psychic type', () => {
    expect(pipe.transform('psychic')).toBe(
  ...
  it('returns correct classes for bug type', () => {
    expect(pipe.transform('bug')).toBe(
      'bg-lime-50 text-lime-700 ring-lime-600/20 dark:bg-lime-900 dark:text-lime-300 dark:ring-lime-500/10',
    );
  });

  it('returns correct classes for rock type', () => {
    expect(pipe.transform('rock')).toBe(
      'bg-stone-50 text-stone-600 ring-stone-500/10 dark:bg-stone-800 dark:text-stone-300 dark:ring-stone-600/10',
    );
  });

  it('returns correct classes for ghost type', () => {
    expect(pipe.transform('ghost')).toBe(
  ...
  it('returns correct classes for dragon type', () => {
    expect(pipe.transform('dragon')).toBe(
  ...
  it('returns correct classes for dark type', () => {
    expect(pipe.transform('dark')).toBe(
      'bg-zinc-50 text-zinc-700 ring-zinc-700/10 dark:bg-zinc-900 dark:text-zinc-300 dark:ring-zinc-400/10',
    );
  });

  it('returns correct classes for steel type', () => {
    expect(pipe.transform('steel')).toBe(
  ...
  it('returns correct classes for fairy type', () => {
    expect(pipe.transform('fairy')).toBe(
